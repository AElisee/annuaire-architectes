      ...
      <form className="h-4/5 md:h-3/5 flex flex-col justify-center  px-4 pt-5  ">
        <div className="flex-1 flex flex-col md:flex-row gap-5 items-center justify-center">
          <div className="w-full md:w-1/4 flex flex-col gap-1">
            <label htmlFor="nom" className="font-semibold text-zinc-600">
              Nom
            </label>
            <input
              type="text"
          ...
          <div className="w-full md:w-1/4 flex flex-col gap-1">
            <label htmlFor="cabinet" className="font-semibold text-zinc-600">
              Cabinet
            </label>
            <input
              type="text"
          ...
          <div className="w-full md:w-1/4 flex flex-col gap-1">
            <label htmlFor="diplome" className="font-semibold text-zinc-600">
              N° d'ordre
            </label>
            <input
              type="text"
